...
.card h4{margin:0;color:#64748b;font-weight:600}
...
.input-search{padding:8px 12px;border-radius:8px;border:1px solid #ccc;width:300px}
.btn-primary{padding:8px 14px;background:#2563eb;color:white;border:none;border-radius:8px;cursor:pointer}
.btn-success{padding:8px 14px;background:#16a34a;color:white;border:none;border-radius:8px;cursor:pointer}
.btn-secondary{padding:8px 14px;background:#e5e7eb;border:none;border-radius:8px;cursor:pointer}
.btn-danger-sm{padding:4px 10px;background:#dc2626;color:white;border:none;border-radius:6px;cursor:pointer}
...
.toast{position:fixed;bottom:20px;right:20px;padding:12px 20px;border-radius:8px;display:none}
