...
<body>
  ...
  <div id="invoiceModal" class="modal-overlay">
    <div class="modal" style="width:520px">
      ...
      <input id="itbis" type="number" step="0.01" placeholder="ITBIS" style="width:100%;margin-bottom:8px"/>
  ...
  <script>
    ...
    loadDashboard();
      ...
      if (url.pathname.startsWith("/api/invoices")) {
        ...
        if (request.method === "POST") {
          try {
            ...
            // Corrección automática de ITBIS si no coincide
            const calculatedItbis = body.subtotal * 0.18;
            const calculatedTotal = body.subtotal + calculatedItbis;

            const finalItbis = body.itbis ?? calculatedItbis;
      ...
      console.error("Error global en Worker:", err);
